        ...
        <div class="relative inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-xl transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-gray-100 dark:border-gray-700">
            <div class="p-6 sm:p-8">
                ...
                <dl class="mt-6 space-y-3 text-sm">
                    ...
                    @if($detailTask->rotation_strategy)
                        <div class="flex justify-between gap-4">
                            <dt class="font-semibold text-gray-500 dark:text-gray-400 flex-shrink-0">{{ __('Wechsel') }}</dt>
                            <dd class="text-right text-gray-900 dark:text-white">{{ $detailTask->rotation_strategy->label() }}</dd>
                        </div>
                    @endif
                    ...
                    @if($detailTask->priority)
                        <div class="flex justify-between gap-4">
                            ...
                            <dd class="text-right text-gray-900 dark:text-white">{{ $detailTask->priority->label() }}</dd>
                        </div>
                    @endif
